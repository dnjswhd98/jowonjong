#include "inCasthle6.h"

USING_NS_CC;

cocos2d::Scene * inCasthle6::createScene()
{
	return inCasthle6::create();
}

bool inCasthle6::init()
{
	...
	map1 = TMXTiledMap::create("zeldaSprites/map/casthle6.tmx");
	auto object1 = map1->getObjectGroup("object");
	auto spwanPoint = object1->getObject("df");
	...
	schedule(schedule_selector(inCasthle6::camera));
...
void inCasthle6::onEnter()
{
	Scene::onEnter();

	_listener = EventListenerKeyboard::create();

	_listener->onKeyPressed = CC_CALLBACK_2(inCasthle6::onKeyPressed, this);
	_listener->onKeyReleased = CC_CALLBACK_2(inCasthle6::onKeyReleased, this);

	_eventDispatcher->addEventListenerWithSceneGraphPriority(_listener, this);
}

void inCasthle6::onExit()
{
	_eventDispatcher->removeAllEventListeners();
	Scene::onExit();
}

void inCasthle6::onKeyPressed(cocos2d::EventKeyboard::KeyCode keycode, cocos2d::Event * event)
{
	switch (keycode)
	{
	case cocos2d::EventKeyboard::KeyCode::KEY_UP_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle6::linkMoveUp));
	...
	case cocos2d::EventKeyboard::KeyCode::KEY_DOWN_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle6::linkMoveDown));
		auto animation = Animation::create();
	...
	case cocos2d::EventKeyboard::KeyCode::KEY_LEFT_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle6::linkMoveLeft));
		auto animation = Animation::create();
	...
	case cocos2d::EventKeyboard::KeyCode::KEY_RIGHT_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle6::linkMoveRight));
		auto animation = Animation::create();
...
void inCasthle6::onKeyReleased(cocos2d::EventKeyboard::KeyCode keycode, cocos2d::Event * event)
{
	switch (keycode)
	{
	case cocos2d::EventKeyboard::KeyCode::KEY_UP_ARROW:
	{
		unschedule(schedule_selector(inCasthle6::linkMoveUp));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_DOWN_ARROW:
	{
		unschedule(schedule_selector(inCasthle6::linkMoveDown));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_LEFT_ARROW:
	{
		unschedule(schedule_selector(inCasthle6::linkMoveLeft));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_RIGHT_ARROW:
	{
		unschedule(schedule_selector(inCasthle6::linkMoveRight));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_Z:
	{
...
void inCasthle6::linkMoveUp(float dt)
{
...
void inCasthle6::linkMoveDown(float dt)
{
	auto x = link->getPositionX();
	auto y = link->getPositionY();
	bool WB = Pbool(Vec2(x, y - 1));
...
void inCasthle6::linkMoveLeft(float dt)
{
	auto x = link->getPositionX();
	auto y = link->getPositionY();
...
void inCasthle6::linkMoveRight(float dt)
{
	auto x = link->getPositionX();
	auto y = link->getPositionY();
	bool WB = Pbool(Vec2(x + 1, y));
...
cocos2d::Vec2 inCasthle6::tileCoordForPosition(cocos2d::Vec2 position)
{
...
bool inCasthle6::Pbool(cocos2d::Vec2 position)
{
...
void inCasthle6::Wbool(cocos2d::Vec2 position)
{

}

void inCasthle6::camera(float dt)
{
	auto follow1 = Follow::create(link, Rect(0, 0, 416, 472));
	_layer1->runAction(follow1);
}

void inCasthle6::uiNum()
{
#pragma region Luffi
...
void inCasthle6::linkAttcks(Ref*sender)
{
