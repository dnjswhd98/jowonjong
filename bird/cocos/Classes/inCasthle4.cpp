#include "inCasthle4.h"

USING_NS_CC;

cocos2d::Scene * inCasthle4::createScene()
{
	return inCasthle4::create();
}

bool inCasthle4::init()
{
	...
	map1 = TMXTiledMap::create("zeldaSprites/map/casthle4.tmx");
	...
	schedule(schedule_selector(inCasthle4::camera));
...
void inCasthle4::onEnter()
{
	Scene::onEnter();

	_listener = EventListenerKeyboard::create();

	_listener->onKeyPressed = CC_CALLBACK_2(inCasthle4::onKeyPressed, this);
	_listener->onKeyReleased = CC_CALLBACK_2(inCasthle4::onKeyReleased, this);

	_eventDispatcher->addEventListenerWithSceneGraphPriority(_listener, this);
}

void inCasthle4::onExit()
{
	_eventDispatcher->removeAllEventListeners();
	Scene::onExit();
}

void inCasthle4::onKeyPressed(cocos2d::EventKeyboard::KeyCode keycode, cocos2d::Event * event)
{
	switch (keycode)
	{
	case cocos2d::EventKeyboard::KeyCode::KEY_UP_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle4::linkMoveUp));
	...
	case cocos2d::EventKeyboard::KeyCode::KEY_DOWN_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle4::linkMoveDown));
		auto animation = Animation::create();
	...
	case cocos2d::EventKeyboard::KeyCode::KEY_LEFT_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle4::linkMoveLeft));
		auto animation = Animation::create();
	...
	case cocos2d::EventKeyboard::KeyCode::KEY_RIGHT_ARROW:
	{
		...
		schedule(schedule_selector(inCasthle4::linkMoveRight));
		auto animation = Animation::create();
...
void inCasthle4::onKeyReleased(cocos2d::EventKeyboard::KeyCode keycode, cocos2d::Event * event)
{
	switch (keycode)
	{
	case cocos2d::EventKeyboard::KeyCode::KEY_UP_ARROW:
	{
		unschedule(schedule_selector(inCasthle4::linkMoveUp));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_DOWN_ARROW:
	{
		unschedule(schedule_selector(inCasthle4::linkMoveDown));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_LEFT_ARROW:
	{
		unschedule(schedule_selector(inCasthle4::linkMoveLeft));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_RIGHT_ARROW:
	{
		unschedule(schedule_selector(inCasthle4::linkMoveRight));
	}
	break;
	case cocos2d::EventKeyboard::KeyCode::KEY_Z:
	{
...
void inCasthle4::linkMoveUp(float dt)
{
...
void inCasthle4::linkMoveDown(float dt)
{
	auto x = link->getPositionX();
	auto y = link->getPositionY();
	bool WB = Pbool(Vec2(x, y - 1));
...
void inCasthle4::linkMoveLeft(float dt)
{
	auto x = link->getPositionX();
	auto y = link->getPositionY();
...
void inCasthle4::linkMoveRight(float dt)
{
	auto x = link->getPositionX();
	auto y = link->getPositionY();
	bool WB = Pbool(Vec2(x + 1, y));
...
cocos2d::Vec2 inCasthle4::tileCoordForPosition(cocos2d::Vec2 position)
{
...
bool inCasthle4::Pbool(cocos2d::Vec2 position)
{
...
void inCasthle4::Wbool(cocos2d::Vec2 position)
{

}

void inCasthle4::camera(float dt)
{
	auto follow1 = Follow::create(link, Rect(0, 0, 208, 128));
	_layer1->runAction(follow1);
}

void inCasthle4::uiNum()
{
#pragma region Luffi
...
void inCasthle4::linkAttcks(Ref*sender)
{
