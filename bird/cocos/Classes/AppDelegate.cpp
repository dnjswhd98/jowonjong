...
bool AppDelegate::applicationDidFinishLaunching() {
  ...
  //  glview->setDesignResolutionSize(designResolutionSize.width, designResolutionSize.height, ResolutionPolicy::NO_BORDER);
	glview->setDesignResolutionSize(256, 224, ResolutionPolicy::NO_BORDER);
  ...
  //  }
   ...
   // auto scene = zeldaP::createScene();
   auto scene = inCasthle6::createScene();
    //auto scene = Overworld2::createScene();
